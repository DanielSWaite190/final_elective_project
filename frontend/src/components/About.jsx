...
function About() {
  return (
    <div id="about">
      ...
      <Image src={require("../media/halo&ark.png")} class="imgTopic" alt="Installation 00, the ark" with="100%"/>
      ...
      <div id="info">
          ...
          <Image src={require("../media/inside.jpeg")} class="imgTopic" alt="Halo construction" with="400px" height="400px"/>
          ...
          <Image src={require("../media/ark.jpg")} class="imgTopic" alt="Installation 00 (pic 2)" with="500px" height="400px" />
          ...
          <Image id="i3" src={require("../media/ship&ark.png")} class="imgTopic" alt="Installation 00 form a ship" with="400px" height="400px"/>        
